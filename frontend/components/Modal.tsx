...
export default function Modal({ children, Title, onClose, isOpen, buttonText }: modalPropType) {
    ...
    return (
        <div className="fixed inset-0 bg-gray-400 bg-opacity-75 transition-opacity" aria-hidden="true">
                    ...
                    <div className="relative p-4 w-full max-w-2xl max-h-full">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="flex justify-end gap-2 p-4 md:p-5 ">
                                <Button type="submit" className='w-fit px-4'>{buttonText}</Button>
                                <Button type="button" className='w-fit px-4 bg-gray-200 text-black' onClick={onClose}>Cancel</Button>
                            </div>
                        </div>
                    </div>
                </div>
