...
export default function Expense() {
    ...
    const comfirmDeleteExpense = (id: string) => {
        setDeletes(true)
        setDeleteId(id)
    }
    ...
    return (
        <HomeLayout>
                        ...
                        <Card className='mt-5 flex flex-col gap-1' key={index}>
                            <div className='flex justify-between'>
                                ...
                                <div className='flex gap-3'>
                                    ...
                                    <button onClick={() => comfirmDeleteExpense(e.id)}>
                                        <div>
                                            <svg xmlns="http://www.w3.org/2000/svg" className='dark:text-white' viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
            ...
            {/* Edit Expense Modal */}
            <Modal Title="Edit Expense" isOpen={edit} onClose={() => setEdit(false)} buttonText="Update">
                <form action="" className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                        <Label>Category</Label>
                        <Select options={expenses} defaultValue={editData?.category} />
                    </div>
                    <div className="flex flex-col gap-1">
                        <Label htmlFor="description">Description</Label>
